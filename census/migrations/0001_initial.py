# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-29 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='title', chained_model_field='title', on_delete=django.db.models.deletion.CASCADE, to='census.Edition')),
            ],
        ),
        migrations.CreateModel(
            name='Provenance',
        ...
        migrations.AddField(
            model_name='copy',
            name='edition',
            field=smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='title', chained_model_field='title', on_delete=django.db.models.deletion.CASCADE, to='census.Edition'),
        ),
        migrations.AddField(
            model_name='copy',
            name='issue',
            field=smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='edition', chained_model_field='edition', on_delete=django.db.models.deletion.CASCADE, to='census.Issue'),
        ),
        migrations.AddField(
            model_name='copy',
            name='title',
